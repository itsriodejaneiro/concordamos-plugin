...
export default function DeleteVotingModal ({ controller }) {
	return (
		<Modal controller={controller} danger={true}>
			...
			<p dangerouslySetInnerHTML={ { __html: sprintf(__('For deleting this voting, send a message for the platform administration with the subject "Delete voting" at the email <a href="mailto:%s">%s</a>'), 'concordamos@mail.com', 'concordamos@mail.com') } }/>
